        ...
        if filename.lower().endswith(valid_extensions):
            ...
            try:
                with Image.open(file_path) as img:
                    ...
                    # Cálculo matemático para Center-Crop perfecto
                    ...
                    # Remuestreo de alta fidelidad LANCZOS
                    img_resized = img_cropped.resize(target_size, Image.Resampling.LANCZOS)
                    
                    # Extracción del nombre sin extensión para forzar .jpg
...
if __name__ == "__main__":
    ...
    print("Iniciando el procesamiento geométrico de imágenes...")
